...
import { ADMIN_LOGIN } from "../../utils/ApiRoutes";
import { useDispatch, useSelector } from "react-redux";
import { reducerCases } from "../../redux/constants/adminConstants";
...
export default function AdminLogin() {
  ...
  const { adminPanelError } = useSelector((state) => state.admin);
  const handleSignIn = async (event) => {
    ...
    try {
      ...
      console.log("caught error while login");
    }
  };
